            ...
            <tr>
              <td class="email-pad" style="padding:56px 58px 52px;background-color:#ffffff;">
                ...
                <p class="email-intro" style="margin:0 0 34px;font-size:21px;line-height:1.65;color:#555555;">
                  Thank you for registering for the <strong>Synergy 2026 Expo offer</strong> with MAHA BINU FIRE FIGHTERS. We have received your registration for a baseline inspection, and our engineering team will contact you shortly to schedule the initial site visit.
                </p>
