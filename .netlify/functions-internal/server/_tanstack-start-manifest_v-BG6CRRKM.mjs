//#region node_modules/.nitro/vite/services/ssr/assets/_tanstack-start-manifest_v-BG6CRRKM.js
var tsrStartManifest = () => ({ routes: {
	__root__: {
		filePath: "/tmp/cc-agent/70809999/project/src/routes/__root.tsx",
		children: ["/", "/admin"],
		preloads: ["/assets/index-DFGCsN4C.js", "/assets/supabase-S0QJyxR7.js"],
		scripts: [{ attrs: {
			type: "module",
			async: !0,
			src: "/assets/index-DFGCsN4C.js"
		} }]
	},
	"/": {
	...
	"/admin/login": {
		...
		children: void 0,
		preloads: ["/assets/login-6ug_adXn.js", "/assets/triangle-alert-CyICWKz9.js"]
	}
} });
//#endregion
