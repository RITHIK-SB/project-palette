...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BRXINaTY.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CV5ATBdK.mjs").then((n) => n.t),
		import("./start-D7NZg9w_.mjs"),
...
//#endregion
export { createCsrfMiddleware as n, createMiddleware as r, server_exports as t };
